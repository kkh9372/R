# 날짜 : 2021/11/15
# 이름 : 김관후
# 내용 : ch.10 분석절차와 가설검정 교재 p153

#####################################
# 스포츠 음료 용량이 제품이 표시된 300ml보다 모자를 것 같아서 직접
...
#4)결론
#통계량 z가 유의수준 임계값인 -1.64보다 작기 때문에 귀무가설을 기각
#따라서 스포츠 음료 용량은 300ml보다 작다.


##########################################
# 어느 제품의 평균무게는 30kg, 표준편차 5로 파악되었다.
# 제품의 표본 10갱에 대한 무게를 측정한 결과 다음과 같다.
...
#4) 결론
# 통계량이 0.316이고 채택역(1.96 < z < 1.96)에 포함이 되기 때뮨에
